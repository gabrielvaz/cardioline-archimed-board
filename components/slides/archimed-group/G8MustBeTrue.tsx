...
import { CL_USAGE, pctCl } from "@/lib/cardioline";
import shared from "../slides.module.css";
import { Source } from "./Source";
import styles from "./G8MustBeTrue.module.css";
...
const RISKS = [
  ...
  },
  {
    ...
    what: `Two operations, two continents: ${pct(USAGE.retentionAnnual)} logo retention a year across ${USAGE.yearPairs} year pairs in Brazil, ${pctCl(CL_USAGE.cohortRetention11m)} over eleven months in the cloud. Neither population has ever been asked to renew at a price.`,
