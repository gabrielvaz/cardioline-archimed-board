...
import styles from "./A6Recurring.module.css";
 ...
 *
 * Duas versões anteriores erraram o denominador. A primeira segmentava por
 * aparelho e dizia que 14% da base dobrava a receita de software. A segunda
 * derivava o volume do parque e punha 32 contas acima de 1.500 exames/mês.
 * Medido no portal, são 9, e o dinheiro está no meio da base.
 *
 * A versão com sliders, para mexer nas premissas ao vivo, é o slide avulso em
 * `_estrategia/2026-09-08-mrr-arr-base-instalada/`.
 */
export function A6Recurring() {
  return (
    <div className={`${shared.full} ${styles.wrap}`}>
      <div className={shared.top}>
        ...
        <Reveal delay={80}>
          <Kicker>24 months, current clients only</Kicker>
        </Reveal>
      </div>
